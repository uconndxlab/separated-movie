...
var HorizontalTimeline = function (element) {
  ...
  this.datesContainer =
    this.element.getElementsByClassName("timeline__dates")[0];
  this.line = this.datesContainer.getElementsByClassName("timeline__line")[0]; // grey line in the top timeline section
  ...
  this.date = this.line.getElementsByClassName("timeline__date");
...
function translateTimeline(timeline, direction) {
  ...
  timeline.translate == 0
    ? Util.addClass(timeline.navigation[0], "timeline__navigation--inactive")
    : Util.removeClass(
        timeline.navigation[0],
        "timeline__navigation--inactive"
      );
  timeline.translate == containerWidth - timeline.lineLength
    ? Util.addClass(timeline.navigation[1], "timeline__navigation--inactive")
    : Util.removeClass(
...
function selectNewDate(timeline, target) {
  ...
  Util.removeClass(timeline.selectedDate, "timeline__date--selected");
  Util.addClass(
...
function updateOlderEvents(timeline) {
  ...
  for (var i = 0; i < timeline.date.length; i++) {
    i < timeline.newDateIndex
      ? Util.addClass(timeline.date[i], "timeline__date--older-event")
      : Util.removeClass(timeline.date[i], "timeline__date--older-event");
  }
}
...
function resetAnimation(timeline) {
  ...
  Util.removeClass(
    ...
    "timeline__event--enter-right timeline__event--enter-left"
  );
  Util.removeClass(
    timeline.content[timeline.oldDateIndex],
...
var horizontalTimeline = document.getElementsByClassName("js-timeline"),
